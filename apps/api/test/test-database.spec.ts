...
describe('assertSafeTestDatabase', () => {
  ...
  it.each([
    ['development mode', 'development', 'postgresql://localhost/app_test'],
    ['a development database', 'test', 'postgresql://localhost/app'],
    ['a production database', 'test', 'postgresql://localhost/app_prod'],
