...
| Mobile | Testing       | [Maestro E2E tests](rules/mobile/testing/maestro-e2e.md)           | Define Maestro ownership, syntax, selectors, test data, critical flows, isolation, and failure diagnosis.             |
...
| [implement-mobile-code](skills/implement-mobile-code/SKILL.md) | Implement or refactor mobile code and Maestro E2E coverage using the relevant focused rules. | [Architecture](rules/mobile/architecture/architecture.md), [components](rules/mobile/components/components.md), [styling](rules/mobile/styling/styling.md), [utilities and testing](rules/mobile/testing/utils-and-testing.md), [Maestro E2E](rules/mobile/testing/maestro-e2e.md), [integrations](rules/mobile/integrations/integrations.md), [Expo](rules/mobile/framework/expo.md) |
