...
```text
features/profile/components/ProfileCard/
├── ProfileCard.tsx
...
business concepts such as ProfileCard, OrderCard, and SubscriptionStatus in their
features.
